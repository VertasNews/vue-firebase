        ...
        <div class="col s12 m8 xl6 offset-m2 offset-xl3">
          <div class="register card-panel black-text center">
            ...
            <div action="index.html">
              ...
              <v-btn outline color="success" @click="$router.push('/')">
                Continue as guest
              </v-btn>
              <v-btn color="white" @click="register">SIGN UP</v-btn>
              <p>
                <br />or Sign up with <br />
  ...
  methods: {
    register: function(e) {
      if (this.password === this.confirmPassword) {
        ...
        e.preventDefault();
      } else alert('Passwords not match, please enter again.');
    },
